...
module.exports = {
  ...
  onRequest: async (client, message, args) => {
    ...
    if(!uye) return message.channel.send(`Hata: Lütfen bir üye etiketleyin veya Id giriniz!  __Örn:__  \`${client.sistem.a_Prefix}seskontrol @acar/ID\``).then(x => x.delete({timeout: 5000}));
