...
module.exports = {
  ...
  onRequest: async function (client, message, args, guild) {
    ...
    if(!uye || !reason) return message.channel.send(`Hata: Lütfen üye belirleyin veya sebep belirleyin!  __Örn:__  \`${client.sistem.a_Prefix}permjail @acar/ID <sebep>\``).then(x => x.delete({timeout: 5000}));
