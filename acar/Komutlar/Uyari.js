...
module.exports = {
  ...
  onRequest: async function (client, message, args, guild) {
    ...
    if(!uye || !reason) return message.channel.send(`Hata: Lütfen bir üye etiketleyin veya Id girin!  __Örn:__  \`${client.sistem.a_Prefix}uyarı @acar/ID <sebep>\``).then(x => x.delete({timeout: 5000}));
